      ...
      <header className="border-b border-border bg-background/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-foreground">BlueWave</span>
          </div>
      ...
      <section className="py-16 px-4 bg-background/50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose BlueWave?</h2>
      ...
      <footer className="border-t border-border bg-background/80 backdrop-blur-sm py-8 px-4">
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="font-semibold text-foreground">BlueWave</span>
          </div>
          <p className="text-muted-foreground">
            © 2024 BlueWave. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
